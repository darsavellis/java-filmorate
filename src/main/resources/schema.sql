...
CREATE TABLE IF NOT EXISTS PUBLIC.FILMS (
	...
	CONSTRAINT DIRECTOR_FK FOREIGN KEY (USER_ID) REFERENCES PUBLIC.DIRECTORS(ID)
);
...
CREATE TABLE IF NOT EXISTS EVENTS (
	...
	CONSTRAINT EVENTS_USER_FK FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS(ID),
	CONSTRAINT EVENTS_TYPES_FK FOREIGN KEY (EVENT_TYPE) REFERENCES PUBLIC.EVENT_TYPES(ID)
);
