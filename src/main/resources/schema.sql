...
CREATE TABLE IF NOT EXISTS PUBLIC.FILM_DIRECTOR (
	...
	CONSTRAINT FILM_DIRECTOR_FILMS_FK FOREIGN KEY (FILM_ID) REFERENCES PUBLIC.RATINGS(ID),
	CONSTRAINT FILM_DIRECTOR_DIRECTORS_FK FOREIGN KEY (DIRECTOR_ID) REFERENCES PUBLIC.DIRECTORS(ID)
);
...
CREATE TABLE IF NOT EXISTS EVENTS (
	...
	CONSTRAINT EVENTS_OPERATIONS_FK FOREIGN KEY (OPERATION_ID) REFERENCES PUBLIC.EVENT_OPERATIONS(ID)
);
