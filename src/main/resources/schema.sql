...
CREATE TABLE IF NOT EXISTS FILMS (
	...
	CONSTRAINT FILMS_RATINGS_FK FOREIGN KEY (RATING_ID) REFERENCES RATINGS(ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS FRIENDSHIPS (
    ...
    CONSTRAINT FRIENDSHIPS_FRIEND_STATUSES_FK FOREIGN KEY (STATUS_ID) REFERENCES FRIEND_STATUSES(ID) ON DELETE CASCADE
);
